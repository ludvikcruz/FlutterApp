...
class HomePage extends StatelessWidget {
        ...
        Container(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () {
                  var routeBuilder = categoryRoutes[category.name];
                  if (routeBuilder != null) {
                    Navigator.of(context).push(MaterialPageRoute(builder: routeBuilder));
                  } else {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('Nenhuma página encontrada para ${category.name}')),
                    );
                  }
                },
                child: Container(
  ...
  // Implemente _dietSection() aqui conforme necessário

  // Implemente _popularSection() aqui conforme necessário, similar a _categoriesSection()
}
